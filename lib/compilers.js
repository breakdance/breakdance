...
module.exports = function(options) {
  ...
  return function(snapdragon) {
    ...
    snapdragon.compiler
      ...
      .set('audio', helpers.noop)
      .set('big', helpers.noop)
      .set('button', helpers.noop)
      .set('canvas', helpers.noop)
      .set('command', helpers.noop)
      .set('data', helpers.noop)
      .set('datalist', helpers.noop)
      .set('embed', helpers.noop)
      .set('iframe', helpers.noop)
      .set('keygen', helpers.noop)
      .set('map', helpers.noop)
      .set('mark', helpers.noop)
      .set('math', helpers.noop)
      .set('meter', helpers.noop)
      .set('object', helpers.noop)
      .set('progress', helpers.noop)
      .set('rb', helpers.noop)
      .set('rp', helpers.noop)
      .set('rt', helpers.noop)
    ...
    function emphasis(openTag) {
      return function(node) {
        ...
        if (next.type === 'text' && !utils.isPunctuation(ch)) {
          this.emit(' ');
        }
      };
    }
