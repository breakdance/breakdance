...
Visit [breakdance.io]({%= homepage %}) for detailed documentation, [examples](https://breakdance.io/examples), [recipes](https://breakdance.io/recipes), and advice on [authoring and finding plugins]({%= homepage %}/plugins.html).
